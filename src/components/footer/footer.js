...
const Footer = ({taskCount, onDeleteAllDone, 
                 onSelectAll, onSelectActive, 
                 onSelectCompleted, filters}) => {
    
    return (
        <footer className="footer">
            <span className="todo-count">{taskCount} tasks left</span>
            <TasksFilter onSelectAll = {() => onSelectAll()}
                         onSelectActive = {() => onSelectActive()}
                         onSelectCompleted = {() => onSelectCompleted()}
                         filters = {filters}/>
            <button className="clear-completed"
                    onClick = {onDeleteAllDone}>Clear completed</button>
          </footer>
    );
}
